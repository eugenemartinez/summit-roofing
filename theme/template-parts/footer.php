...
<div class="absolute top-0 left-0 w-full overflow-hidden leading-0 transform -translate-y-99%">
    ...
    >
      ...
      <div data-motion="fade-up" data-scroll="true">
        ...
        <div class="flex space-x-4">
            <a href="#" class="bg-white/10 hover:bg-cta p-2 rounded-full transition-colors duration-300 flex items-center justify-center" data-motion="hover-scale">
      ...
      <div data-motion="fade-up" data-scroll="true" data-delay="0.1">
        <h3 class="text-lg font-semibold mb-6 border-b border-white/20 pb-2 flex items-center">
          <span class="w-1.5 h-6 bg-cta rounded-full mr-2 inline-block"></span>
          Quick Links
        </h3>

        <ul class="space-y-3">
          <li>
            <a href="<?php echo esc_url(home_url('/#about')); ?>" class="text-white/80 hover:text-cta transition-colors duration-300 flex items-center" data-motion="hover-lift">
              <span class="mr-2 text-cta">›</span> About Us
            </a>
          </li>
          <li>
            <a href="<?php echo esc_url(home_url('/#services')); ?>" class="text-white/80 hover:text-cta transition-colors duration-300 flex items-center" data-motion="hover-lift">
              <span class="mr-2 text-cta">›</span> Our Services
            </a>
          </li>
          <li>
            <a href="<?php echo esc_url(home_url('/#projects')); ?>" class="text-white/80 hover:text-cta transition-colors duration-300 flex items-center" data-motion="hover-lift">
              <span class="mr-2 text-cta">›</span> Recent Projects
            </a>
          </li>
          <li>
            <a href="<?php echo esc_url(home_url('/#testimonials')); ?>" class="text-white/80 hover:text-cta transition-colors duration-300 flex items-center" data-motion="hover-lift">
              <span class="mr-2 text-cta">›</span> Testimonials
            </a>
          </li>
          <li>
            <a href="<?php echo esc_url(home_url('/#faq')); ?>" class="text-white/80 hover:text-cta transition-colors duration-300 flex items-center" data-motion="hover-lift">
              <span class="mr-2 text-cta">›</span> FAQ
            </a>
          </li>
          <li>
            <a href="<?php echo esc_url(home_url('/#contact')); ?>" class="text-white/80 hover:text-cta transition-colors duration-300 flex items-center" data-motion="hover-lift">
      ...
      <div data-motion="fade-up" data-scroll="true" data-delay="0.3">
        ...
        <ul class="space-y-4">
          <li class="flex items-start">
            <div class="bg-white/10 hover:bg-white/20 p-2 rounded-full mr-3 mt-1 transition-all duration-300" data-motion="hover-scale">
          ...
          <li class="flex items-center">
            <div class="bg-white/10 hover:bg-white/20 p-2 rounded-full mr-3 transition-all duration-300" data-motion="hover-scale">
              <i data-lucide="phone" class="w-5 h-5 text-cta"></i>
            </div>
            <a href="tel:+15551234567" class="text-white/80 hover:text-cta transition-colors duration-300" data-motion="hover-lift">
              (555) 123-4567
            </a>
          </li>
          ...
          <li class="flex items-center">
            ...
            <a href="mailto:contact@summitroofing.com" class="text-white/80 hover:text-cta transition-colors duration-300" data-motion="hover-lift">
  ...
  <div class="bg-accent py-4">
    <div class="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-sm text-white/70">
      <div data-motion="fade-in" data-delay="0.5">
        © <?php echo esc_html($current_year); ?> Summit Roofing. All rights reserved.
      </div>
      <div class="flex flex-wrap justify-center space-x-4 mt-3 md:mt-0" data-motion="fade-in" data-delay="0.6">
        <a href="#" class="hover:text-cta transition-colors duration-300" data-motion="hover-lift">Privacy Policy</a>
        <a href="#" class="hover:text-cta transition-colors duration-300" data-motion="hover-lift">Terms of Service</a>
        <a href="#" class="hover:text-cta transition-colors duration-300" data-motion="hover-lift">Sitemap</a>
      </div>
    </div>
  </div>
</footer>
