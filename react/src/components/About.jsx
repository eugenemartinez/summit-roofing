        ...
        >
          ...
          >
            <div className="relative">
              <motion.img 
                src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?q=80&w=2574" 
          ...
          >
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <div className="h-1 w-12 bg-cta mr-4"></div>
              <span className="text-accent uppercase tracking-wider text-sm font-semibold">About Us</span>
            </motion.div>
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              At Summit Roofing, we've built our reputation on quality craftsmanship, honest pricing, and exceptional customer service. Our team of experienced professionals is dedicated to providing top-tier roofing solutions for both residential and commercial properties.
            </motion.p>
              ...
              {[
                {
                  ...
                  description: "Trained professionals with meticulous attention to detail"
                },
                {
            ...
            <motion.a 
              href="#services" 
              className="inline-flex items-center text-cta font-medium hover:text-secondary transition-colors duration-300 group cursor-pointer"
              whileHover={{ x: 5 }}
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
